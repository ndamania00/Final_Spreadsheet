...
/**
 * Represents the visualization of selected data as a Line Graph.
 */
public class LineGraph extends JFrame implements IGraph {
  ...
  /**
   * Constructs a Line Graph showing the count of the given data.
   ...
   */
  public LineGraph(String chartTitle, String range, IWorksheetGetters model, boolean existence) {
    super("Line Chart");
  ...
  private CategoryDataset createDataset() {
    ...
    for (ICell cell : cells) {
      ...
      result.setValue(count,"item",content);
    }
    return result;
  }
  ...
  private JFreeChart createChart(CategoryDataset dataset, String title) {
    ...
    JFreeChart chart = ChartFactory.createLineChart("Something", "Item",
            "Count", dataset);
